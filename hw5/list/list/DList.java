...
public class DList extends List {
  ...
  public DList() {
    this.size = 0;
    this.head = newNode(null, null, null, null); // sentinel.myList = null
  ...
  public void insertFront(Object item) {
    ...
    DListNode prevNode = this.head;
    DListNode nextNode = this.head.next;
    DListNode insertNode = newNode(item, this, prevNode, nextNode);
  ...
  public void insertBack(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
    DListNode prevNode = this.head.prev;
    DListNode nextNode = this.head;
    DListNode insertNode = newNode(item, this,prevNode, nextNode);
    prevNode.next = insertNode;
    nextNode.prev = insertNode;
    this.size ++;
